 ...
 */
public class Problems implements ProblemInterface{
...
/****************************start problem6***********************************************************************************/
    ...
    public int  evaluateResultPostfix(String[] str, int count,int str_length,int res){
        ...
        if(str.length>=3){
            if(str[count].equals("+")){
                ...
                evaluateResultPostfix(str,0,str_length,res);
            }
                ...
                evaluateResultPostfix(str,count+1,str_length,res);
            }
            return res;
        }
        return res;
     ...
     * @param str_length is size of str
     */
    public int  evaluateResultPrefix(String[] str, int count,int str_length,int res){
        ...
        if(str.length>=3){
            if(str[count].equals("+")){
                ...
                str_length=str_length-2;
                evaluateResultPrefix(str,str_length,str_length,res);
            }
            else if(str[count].equals("-")){
                ...
                evaluateResultPrefix(str,count-1,str_length,res);
            }
            return res;
        }
