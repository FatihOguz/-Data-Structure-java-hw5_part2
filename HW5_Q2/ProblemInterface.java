...
public interface ProblemInterface {
     ...
     */
    public abstract int evaluateResultPostfix(String[] str, int count,int str_length,int res);
     ...
     * @param str_length is size of str
     */
    public abstract int evaluateResultPrefix(String[] str, int count,int str_length,int res);
}
